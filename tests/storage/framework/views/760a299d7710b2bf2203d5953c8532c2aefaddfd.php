        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Covid19" width="50px">
                </div>
                        ...
                        <div class="p-6">
                            <a href="<?php echo e(route('users.index')); ?>">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Back END</div>
                                </div>
                            </a>
...
<?php /**PATH /var/www/corona/resources/views/welcome.blade.php ENDPATH**/ ?>